...
namespace ProjectCode
{
    internal class CustomerArrayListExample
    {
        ...
        public ArrayList customers;   //created ArrayList without initializing
    ...
    internal class ArrayListProgram
    {
        ...
        {
            // Created an instance of CustomerArrayListExample(Present Class)
            ...
            // Get customer by ID
            Customer customer = customerArray.GetCustomerById(7);
            if (customer != null)
            {
