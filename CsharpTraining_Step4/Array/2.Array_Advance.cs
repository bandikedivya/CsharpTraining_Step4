...
namespace ProjectCode
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Customer updatedCustomer2 = new Customer(2, "Jane Doe", "jane.doe@example.com", "098-765-4321");  //Customer class(constructor)
            customerArray.UpdateCustomer(updatedCustomer2);
            Console.WriteLine(updatedCustomer2);
...
/*
/// <summary>
/// This code demonstrates a simple  customer managemearray-basednt system.
/// 
/// Key components:
